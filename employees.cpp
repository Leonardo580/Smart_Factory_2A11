...
void Employees::setId(unsigned int i)
{
  id=i;
}
...
bool Employees::add_employee()
{
  ...
  query.prepare("INSERT INTO Employees(CIN, Full_Name,Age,  Address, Email, id) values "
                "(:CIN, :Full_Name,:Age,  :Address, :Email, :id);");
...
QSqlQueryModel * Employees::display_Employee()
{
  ...
  query->setHeaderData(5, Qt::Horizontal, "id");
  return query;
